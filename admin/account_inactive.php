...
<head lang="en">
	...
	<title>Twitouch | Acount Inactive</title>
					...
					<div class="row">
						<div class="col-md-6">
								<fieldset class="form-group">
									...
									<input type="text" name="pri_contact_name" class="form-control" id="inputPassword" placeholder="">
								</fieldset>
								<fieldset class="form-group">
									<label class="form-label">Password</label>
									<input type="password" name="pri_contact_mobile" class="form-control" id="inputPassword"></input>
								</fieldset>
								<fieldset class="form-group">
